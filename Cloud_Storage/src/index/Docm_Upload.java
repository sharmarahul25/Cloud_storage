 ...
 *  
 */
public class Docm_Upload {
    JFrame f1=new JFrame("Upload Documentaries");
    ...
    String type[] = {"History","Patiotic","Drama","Life scenarios","Diferent"};
    ...
    String s1="ftp://172.16.1.1/Documentaries/";
    int il,il1,cc=0;
    Statement stat;
    ResultSet rs;
    String ad;
    //
    public Docm_Upload(String admin){
        ad=admin;
        Container content = f1.getContentPane();
            ...
            @Override
             ...
             FTPUtils u=new FTPUtils();
                ...
                ss6=null;
                ss7=null;
                s1="ftp://172.16.1.1/Documentaries/";
            }
            });
